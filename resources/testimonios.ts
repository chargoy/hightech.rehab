...
const testimonials: Testimonial[] = [
  {
    image: Testimonio1,
    text: "Estoy profundamente agradecida con la clínica de fisioterapia por su atención excepcional, desde la evaluación personalizada hasta el trato amable y profesional del equipo. Gracias al compromiso y conocimiento de los fisioterapeutas, especialmente del Dr. Jaime Carrillo, y al ambiente moderno y acogedor del lugar, experimenté una notable mejoría en poco tiempo. Recomiendo esta clínica al 100% por su calidad y calidez humana.",
    name: "Angélica Medina",
  },
  {
    image: Testimonio2,
    text: "Quiero agradecer al Dr. Jaime Carrillo y a su equipo por la atención profesional y humana que recibí durante mi tratamiento. Desde el primer día, me sentí acompañado por su compromiso, claridad en el diagnóstico y dedicación en cada sesión. La clínica ofrece un ambiente cálido y bien equipado, lo que hizo mi recuperación más efectiva y motivadora. Recomiendo ampliamente sus servicios.",
