...
const navigation: { social: SocialLink[] } = {
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/REHBILITACIONYMEDICINADELAACTIVADFISICA",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/hightech_rehab_and_sport",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <dl className="mt-10 space-y-4 text-base/7 text-gray-600 flex flex-col md:flex-row md:justify-center md:gap-20">
